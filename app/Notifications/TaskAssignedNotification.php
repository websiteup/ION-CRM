...
class TaskAssignedNotification extends Notification
{
    ...
    public function via($notifiable): array
    {
        ...
        // Email notification
        if ($notifiable->notification_email_enabled && $notifiable->notification_task_assigned) {
            $channels[] = 'mail';
        }
        
        // Telegram notification
        if ($notifiable->notification_telegram_enabled && $notifiable->notification_task_assigned && $notifiable->telegram_chat_id) {
            $channels[] = 'telegram';
        }
    ...
    public function toMail($notifiable): MailMessage
    {
        ...
        return (new MailMessage)
                    ->subject('Task atribuit: ' . $this->task->title)
                    ->line('Ți-a fost atribuit un task nou.')
